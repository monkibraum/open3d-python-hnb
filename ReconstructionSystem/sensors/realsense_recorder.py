...
if __name__ == "__main__":
    ...
    DEVICE_SERIAL_1 = "831612073583"
    DEVICE_SERIAL_2 = "831612072848"
    DEVICE_SERIAL_3 = "831612072839"
    ...
    if args.record_imgs or args.record_rosbag:
        ...
        config_1.enable_device(DEVICE_SERIAL_1)
        config_1.enable_stream(rs.stream.depth, 640, 480, rs.format.z16, 30)
        config_1.enable_stream(rs.stream.color, 640, 480, rs.format.bgr8, 30)
       
        config_2.enable_device(DEVICE_SERIAL_2)
